...
from dataset_ucf import custom_dataset
from model import custom_model, CONFIG_PATH, CKPT_PATH
...
def main(args):
    ...
    model_t.load_state_dict(torch.load(CKPT_PATH[args.model_t])["state_dict"])
